...
class PuzzleScene3: SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        piece1 = createNode(at: CGPoint(x: 518, y: 700), imageNamed: "ambulance_row-2-col-1", size: pieceSize, myName: "piece1")
        piece2 = createNode(at: CGPoint(x: 1918, y: 700), imageNamed: "ambulance_row-2-col-2", size: pieceSize, myName: "piece2")
        piece3 = createNode(at: CGPoint(x: 1918, y: 280), imageNamed: "ambulance_row-1-col-1", size: pieceSize, myName: "piece3")
        piece4 = createNode(at: CGPoint(x: 518, y: 280), imageNamed: "ambulance_row-1-col-2", size: pieceSize, myName: "piece4")
            ...
            switch node.name {
                case "piece1":
                    ...
                    if (piece1isComplete && piece2isComplete && piece3isComplete && piece4isComplete) {
                        ...
                        //Puzzle completion
                        createDoneScene(imageNamed: "ambulance_complete")
                    }
                case "piece2":
                    //Get distance between correct location
                    let distance = distanceBetweenNodes(node1: node, node2: targetFrame2)
